                    ...
                    {messages.length === 0 ? (
                        <div className="flex h-full items-center justify-center">
                            <div className="text-center">
                                <h1 className="mb-2 text-2xl font-semibold">
                                    {activeAgent.name === "Personal" && "How can I help you today?"}
                                    {activeAgent.name === "Planner" && "Let's get organized."}
                                    {activeAgent.name === "Coach" && "Ready to achieve your goals?"}
                                    {activeAgent.name === "Health" && "Let's focus on your well-being."}
                                    {activeAgent.name === "Finance" && "Manage your finances with confidence."}
                                </h1>
                                <p className="text-muted-foreground">
                                    {activeAgent.name === "Personal" && "I'm your personal assistant. Ask me anything."}
                                    {activeAgent.name === "Planner" && "I can help you plan your day, manage tasks, and set reminders."}
                                    {activeAgent.name === "Coach" && "I'm here to motivate you and help you stay on track."}
                                    {activeAgent.name === "Health" && "Track your customized health plan and get wellness tips."}
                                    {activeAgent.name === "Finance" && "Track expenses, budget smarter, and grow your wealth."}
                                </p>
                            </div>
                        </div>
                    ) : (
                        <div className="space-y-6">
                            {messages.map((message) => (
                                ...
                                >
                                    <div
                                        className={`max-w-[85%] rounded-lg px-4 py-3 text-sm leading-relaxed break-words ${message.role === "user"
